...
Open <http://localhost:8080> in your browser. You should see a cute puppy and a cute kitten.
...
Visit <http://spring-petclinic.k8s.test>. You should still be able to see two cute animals.
